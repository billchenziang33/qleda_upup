...
<svg xmlns="http://www.w3.org/2000/svg" width="900" height="${height}" viewBox="0 0 900 ${height}">
  ...
  <text x="72" y="108" fill="#073f34" font-family="Arial, sans-serif" font-size="56" font-weight="900" letter-spacing="-3">QLEDA</text>
  ...
  <text x="86" y="334" fill="#0f765e" font-family="Arial, sans-serif" font-size="18" font-weight="700">截止日期 ${escapeXml(input.task.dueDate)} · ${escapeXml(input.task.score ?? "暂无分数")}</text>
  ...
  <text x="86" y="${height - 58}" fill="#69736c" font-family="Arial, sans-serif" font-size="16">Generated by QLEDA Teaching Operations</text>
</svg>`;
